...
class DeepModel(torch.nn.Module):
	...
	@staticmethod
	def evaluate_method(p, data, metrics, threshold=0.5):
		"""
	...
	def __init__(self, user_num, item_num, u_vector_size, i_vector_size, model_path, layers, smooth_coef=0.1, loss_func='BCE'):
	...
	def predict(self, feed_dict):
		...
		pre_layer = torch.cat((user_vectors, item_vectors), dim=1)
		...
		hinge_pred = self.prediction(pre_layer).view([-1])
